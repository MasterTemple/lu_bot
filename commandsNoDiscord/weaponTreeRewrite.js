        ...
        for(var x=0;x<ground_action.length;x++) {
            ...
            try{
                ...
                if (informationBehaviorTemplate.templateID == `43`) {
                    ...
                    // console.log(informationBehaviorTemplate.templateID)
                    // console.log(parseInt(chargeUpBehavior))
                    chargeUp = true
                    stuff.chargeUp = true
